...
{/* test variable communication in react https://www.pluralsight.com/guides/react-communicating-between-components */}

{/* <Comp1 test={test} handleSetTest={handleSetTest}/>
<Comp2 test={test} handleSetTest={handleSetTest}/>
<h1>test={test}</h1> */}

{/* Custom video player */}
{/* <VideoPlayer src="http://upload.wikimedia.org/wikipedia/commons/7/79/Big_Buck_Bunny_small.ogv"/> */}
{/* <VideoPlayer src="http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4"/> */}
{/* Time component */}
{/* <TimeComp purpose="To"/>
<TimeComp purpose="From"/> */}
